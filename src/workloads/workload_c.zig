...
/// Document structure for workload C
...
/// Simulates a user profile cache - read only workload
pub const WorkloadC = struct {
    ...
    pub fn init(allocator: Allocator, io: Io, client: *ShinyDbClient, space_name: []const u8, store_name: []const u8, config: Config) !WorkloadC {
